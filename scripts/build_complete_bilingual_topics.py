...
# Complete Parte I (Fundamentos Esenciales)
parte1_topics = [
    {
        "id": "p1_fis_01",
        "part": "parte1",
        ...
        "stepByStep": [
            {"step": "1", "text": "Identifica si la aceleración es nula (MRU) o constante (MRUV)."},
            {"step": "2", "text": "Convierte todas las magnitudes al SI (m, s, m/s)."},
            {"step": "3", "text": "Aplica la ecuación cinemática que relacione los datos conocidos."}
        ],
        "example": {
    ...
    },
    {
        ...
        "stepByStep": [
            {"step": "1", "text": "Aísla el cuerpo y dibuja el diagrama de cuerpo libre."},
            {"step": "2", "text": "Descompón fuerzas en ejes paralelo y perpendicular al movimiento."},
            {"step": "3", "text": "Aplica ΣF = m·a en el eje del movimiento."}
        ],
        "example": {
    ...
    },
    {
        ...
        "stepByStep": [
            {"step": "1", "text": "Fija el nivel de referencia h = 0."},
            {"step": "2", "text": "Calcula la energía mecánica inicial E_1."},
            {"step": "3", "text": "Iguala con la energía final E_2 y despeja la rapidez o altura."}
        ],
        "example": {
    ...
    },
    {
        ...
        "variables": ["p: momento lineal (kg·m/s)", "J: impulso (N·s)", "F: fuerza media (N)", "Δt: tiempo (s)"],
        "sections": [
            {
        ...
        "stepByStep": [
            {"step": "1", "text": "Define la dirección positiva de referencia."},
            {"step": "2", "text": "Calcula el impulso J = F·Δt."},
            {"step": "3", "text": "Iguala J a m(v_f - v_0) para hallar la velocidad."}
        ],
        "example": {
    ...
    },
    {
        ...
        "variables": ["Nox: número de oxidación", "Alcalinos: +1", "Alcalinotérreos: +2", "Oxígeno: -2", "Hidrógeno: +1"],
        "sections": [
            {
        ...
        "stepByStep": [
            {"step": "1", "text": "Escribe los Nox fijos conocidos (O = -2, H = +1)."},
            {"step": "2", "text": "Plantea la ecuación: Σ Nox = 0."},
            {"step": "3", "text": "Despeja el Nox del átomo central y nombra según Stock."}
        ],
        "example": {
    ...
    },
    {
        ...
        "variables": ["A: masa atómica", "Z: número atómico (protones)", "n: neutrones", "e⁻: electrones"],
        "sections": [
            {
        ...
        "stepByStep": [
            {"step": "1", "text": "Ubica Z (protones) y A (número másico)."},
            {"step": "2", "text": "Halla neutrones: n = A - Z."},
            {"step": "3", "text": "Ajusta electrones según la carga del ion."}
        ],
        "example": {
    ...
    },
    {
        ...
        "variables": ["μ: momento dipolar", "Lineal: 180°", "Trigonal plana: 120°", "Tetraédrica: 109.5°", "Angular: 104.5°"],
        "sections": [
            {
        ...
        "stepByStep": [
            {"step": "1", "text": "Dibuja la estructura de Lewis con pares enlazantes y libres."},
            {"step": "2", "text": "Cuenta dominios sobre el átomo central para definir la geometría."},
            {"step": "3", "text": "Verifica si los vectores dipolo se cancelan vectorialmente."}
        ],
        "example": {
    ...
    },
    {
        ...
        "stepByStep": [
            {"step": "1", "text": "Calcula los moles de reactivos: n = m / M."},
            {"step": "2", "text": "Divide entre sus coeficientes para hallar el limitante."},
            {"step": "3", "text": "Calcula el producto teórico a partir del limitante."}
        ],
        "example": {
...
parte2_topics = [
    {
        ...
        "variables": ["K: cinética (J)", "Ug: potencial gravitatoria (J)", "Ue: potencial elástica (J)", "Em: energía mecánica"],
        "sections": [
            {
...
print("Generated clean js/study-data-all.js successfully!")
