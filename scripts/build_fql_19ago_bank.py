# =============================================================================
# GENERADOR MAESTRO DE BANCO Y FIGURAS FQL - 19 AGOSTO 2026 (120 ÍTEMS - 2 INTENTOS COMPLETOS)
# =============================================================================
# Incluye 8 lecturas contextuales (40 ítems), 40 ítems de Física y 40 ítems de Química
# con formulación matemática LaTeX ($ ... $ y $$ ... $$), resolución a mano en 3 pasos,
# enlaces directos a teoría y tipografía matemática limpia en todas las figuras SVG.
# =============================================================================
import json
...
qui_items_data = [
    ...
    },
    {
        ...
        "ch": "qui-L04",
        "t": "Configuración de Sodio y Catión",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L04",
        "t": "Configuración de Ion de Transición Fe2+",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L17",
        "t": "Estequiometría con Exceso de Magnesio",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L17",
        "t": "Síntesis de Urea y Volumen en CNPT",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L12",
        "t": "Geometría y Polaridad del CO2",
        "fig": "fql19-lewis-co2",
    ...
    },
    {
        ...
        "ch": "qui-L07",
        "t": "Tendencia de Electronegatividad",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L13",
        "t": "Puentes de Hidrógeno en Agua",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L14",
        "t": "Masa Molar del Dihidrógeno Fosfato de Potasio",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L08",
        "t": "Nomenclatura Stock de Cloruro Férrico",
        "fig": None,
    ...
    {
        "topics": [
            "4.3.2-nomInorganica2"
        ],
        "ch": "qui-L09",
        "t": "Fórmula del Dicromato de Potasio",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L08",
        "t": "Peróxido de Sodio y Número de Oxidación",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L09",
        "t": "Oxácidos y Regla de Formulación",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L10",
        "t": "Enlace Iónico y Transferencia de Electrones",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L14",
        "t": "Número de Avogadro y Cantidad de Moléculas",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L07",
        "t": "Energía de Primera Ionización",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L15",
        "t": "Fórmula Empírica y Molecular de Glucosa",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L17",
        "t": "Estequiometría con Pureza de Reactivo",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L09",
        "t": "Oxácidos de Nitrógeno HNO3 y HNO2",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L13",
        "t": "Fuerzas Dipolo-Dipolo en HCl",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L04",
        "t": "Configuración del Anión Cloruro Cl-",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L16",
        "t": "Agente Oxidante y Reductor en Redox de Cobre",
        "fig": None,
    ...
    },
    {
        ...
        "ch": "qui-L01",
        "t": "Cálculo de Densidad y Conversión de Unidades",
        "fig": None,
...
# ---------------------------------------------------------
# EXPORTACIÓN DE GUIA-BANK-FQL-19AGO.JS
# ---------------------------------------------------------
bank_payload = {
    "len": len_items,
    "fis": fis_items,
        ...
        "len": [
            {
                "pack_id": p["pack_id"],
                "reading": p["reading"],
                "qids": [f"len-19ago-{idx:02d}" for idx in range(i*5+1, i*5+6)]
            }
            for i, p in enumerate(len_packs)
        ]
    }
}

js_content = "window.GUIA_BANK_FQL_19AGO = " + json.dumps(bank_payload, indent=2, ensure_ascii=False) + ";\n"
with open("guia-bank-fql-19ago.js", "w", encoding="utf-8") as f:
    f.write(js_content)

print(f"Saved guia-bank-fql-19ago.js successfully with {len(len_items) + len(fis_items) + len(qui_items)} items.")
